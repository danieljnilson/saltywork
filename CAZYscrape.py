...
home = os.getenv("HOME")
directory = home + "/saltywork/data/results/CAZYscrape/"
...
if not os.path.exists(os.path.dirname(home+"/saltywork/data/results/CAZYscrape/")): # Checks to see if directory is already there
    os.makedirs(os.path.dirname(home+"/saltywork/data/results/CAZYscrape/")) # Makes directory     
    
workbook = xlsxwriter.Workbook(home+"/saltywork/data/results/CAZYscrape/CAZYarchaea.xlsx")  # Makes Excel worksheet
